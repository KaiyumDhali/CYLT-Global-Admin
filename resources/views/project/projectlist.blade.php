                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-auto">
                                        <div class="text-sm-end">
                                            <a href="{{ route('projects.index') }}" class="btn btn-primary" id="addService-btn">
                                        ...
                                        <tbody>
                                            @foreach($projects as $key => $project)
                                                <tr>
                                                    ...
                                                    <td>{{ $project->othertext ?? '-' }}</td>
                                                    <td>
                                                        @if($project->image)
                                                            <img src="{{ asset('storage/' . $project->image) }}" alt="project Image" style="width: 80px; height: 50px; object-fit: cover;">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                       ...
                                                       <form action="{{ route('projects.destroy', $project->id) }}" method="POST" class="d-inline" id="deleteForm{{ $project->id }}">
                                                            @csrf
                                                            @method('DELETE')
