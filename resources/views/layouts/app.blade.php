...
<!-- Mirrored from themesbrand.com/skote/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Sep 2025 06:30:40 GMT -->
<head>
        
        <meta charset="utf-8" />
         <title>@yield('NRB Software')</title>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="index.html" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="assets/images/FabIcon-KVrUKMri.png" alt="" height="60">
                                </span>
                            </a>
                        </div>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                               ...
                               <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    ...
                                    <span key="t-company">Home Page</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('homepage.edit')}}" key="t-default">home page</a></li>
                                    <!-- <li><a href="{{route('products.create')}}" key="t-saas">Add Product</a></li> -->
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="bx bx-home-circle"></i>
                                    <span key="t-company">Company Setting</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('company.index')}}" key="t-default">Company List</a></li>
                                    <li><a href="{{route('company.create')}}" key="t-saas">Add Company</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    ...
                                    <span key="t-company">Employee</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('employees.index')}}" key="t-default">Employee List</a></li>
                                    <li><a href="{{route('employees.create')}}" key="t-saas">Add Employee</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    ...
                                    <span key="t-company">Slider</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('slider.list')}}" key="t-default">Slider List</a></li>
                                    <li><a href="{{route('slider.index')}}" key="t-saas">Add Slider</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                   <i class="bx bx-images"></i>
                                    <span key="t-company">Gallery</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('gallery.list')}}" key="t-default">Gallery List</a></li>
                                    <li><a href="{{route('gallery.index')}}" key="t-saas">Add Gallery</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    ...
                                    <span key="t-company">Service</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('services.list')}}" key="t-default">Service List</a></li>
                                    <li><a href="{{route('services.index')}}" key="t-saas">Add Service</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                   <i class="bx bx-info-circle"></i>
                                    <span key="t-company">About</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('about.list')}}" key="t-default">About List</a></li>
                                    <li><a href="{{route('about.index')}}" key="t-saas">Add About</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    ...
                                    <span key="t-company">Our Clients</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('clients.list')}}" key="t-default">Clients List</a></li>
                                    <li><a href="{{route('clients.index')}}" key="t-saas">Add Client</a></li>
                                    <li><a href="{{route('client-reviews.create')}}" key="t-saas">Add Client review</a></li>
                                    <li><a href="{{route('client-reviews.index')}}" key="t-saas"> Client review List</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    ...
                                    <span key="t-company">Our Project</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('projects.list')}}" key="t-default">Project List</a></li>
                                    <li><a href="{{route('projects.index')}}" key="t-saas">Add Project</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="bx bx-package"></i>
                                    <span key="t-company">Our Product</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('products.list')}}" key="t-default">Product List</a></li>
                                    <li><a href="{{route('products.create')}}" key="t-saas">Add Product</a></li>
            ...
            <main>
              ...
              <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-2">
                                <script>document.write(new Date().getFullYear())</script> © Cylt Global.
                            </div>
                            <div class="col-sm-6">
...
<!-- Mirrored from themesbrand.com/skote/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Sep 2025 06:31:28 GMT -->
</html>